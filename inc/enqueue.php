...
if (! function_exists('ezpzconsultations_favicon_script') ) {
    /**
     ...
     */
    function ezpzconsultations_favicon_script()
    {
        echo '
...
add_action('wp_head', 'ezpzconsultations_favicon_script');

if (! function_exists('ezpzconsultations_add_favicon_to_admin') ) {
    // Add favicon to admin areas
    function ezpzconsultations_add_favicon_to_admin()
    {
        $favicon_url = FAVICON_DIR.'/favicon.ico';
        echo '<link rel="shortcut icon" href="' . $favicon_url . '" />';
    }
}
add_action('login_head', 'ezpzconsultations_add_favicon_to_admin');
add_action('admin_head', 'ezpzconsultations_add_favicon_to_admin');
